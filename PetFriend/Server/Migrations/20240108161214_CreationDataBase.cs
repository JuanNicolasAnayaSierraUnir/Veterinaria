        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CitiesModelId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Roles_Roles_RolId",
                        column: x => x.RolId,
            ...
            migrationBuilder.CreateTable(
                name: "Veterinarians_Specialties",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Veterinarians_Specialties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Veterinarians_Specialties_Specialties_SpecialtyId",
                        column: x => x.SpecialtyId,
                        principalTable: "Specialties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Veterinarians_Specialties_Veterinarians_VeterinarianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Veterinarians_Specialties_SpecialtyId",
                table: "Veterinarians_Specialties",
                column: "SpecialtyId");

            migrationBuilder.CreateIndex(
                name: "IX_Veterinarians_Specialties_VeterinarianId",
                table: "Veterinarians_Specialties",
